import { IAggregatedData, INewStudiesDto, ISummaryChartData } from '../../models';
import { aggregateMultipleLine } from './aggregateMultipleLine';
import { aggregateOneLine } from './aggregateOneLine';

function aggregateDataForChart(data: IAggregatedData<INewStudiesDto>): ISummaryChartData[] {
